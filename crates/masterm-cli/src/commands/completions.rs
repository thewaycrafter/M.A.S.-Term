...
fn build_cli() -> clap::Command {
    clap::Command::new("masterm")
        ...
        .subcommand(clap::Command::new("uninstall")
            .about("Uninstall MASTerm from your shell"))
        ...
        .subcommand(clap::Command::new("plugins")
            ...
            .subcommand(clap::Command::new("search")
        ...
        .subcommand(clap::Command::new("mode")
            ...
            .arg(clap::Arg::new("mode")
                .value_parser(["minimal", "dev", "ops"])))
        .subcommand(clap::Command::new("profile")
            .about("Performance profiling")
            .subcommand(clap::Command::new("startup"))
            .subcommand(clap::Command::new("prompt"))
            .subcommand(clap::Command::new("plugins")))
        .subcommand(clap::Command::new("cache")
